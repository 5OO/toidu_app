...
-- Last modification date: 2022-05-05 08:35:37.081
...
ALTER TABLE toidu_app.contact ADD CONSTRAINT contact_user
    FOREIGN KEY (user_id)
    REFERENCES toidu_app."user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;

-- Reference: day_plan_user (table: day_plan)
ALTER TABLE toidu_app.day_plan ADD CONSTRAINT day_plan_user
    FOREIGN KEY (user_id)
    REFERENCES toidu_app."user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE toidu_app.recipe ADD CONSTRAINT recipe_user
    FOREIGN KEY (user_id)
    REFERENCES toidu_app."user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE toidu_app.user_role ADD CONSTRAINT user_role_user
    FOREIGN KEY (user_id)
    REFERENCES toidu_app."user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
