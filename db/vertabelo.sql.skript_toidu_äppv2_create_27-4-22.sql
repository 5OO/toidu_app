...
CREATE TABLE ingredient_in_ingredient_group (
    id serial  NOT NULL,
    ingredient_id int  NOT NULL,
...
ALTER TABLE allowed_measure_unit ADD CONSTRAINT allowed_measure_unit_ingredient
...
ALTER TABLE allowed_measure_unit ADD CONSTRAINT allowed_measure_unit_measure_unit
...
ALTER TABLE contact ADD CONSTRAINT contact_users
...
ALTER TABLE ingredient_in_ingredient_group ADD CONSTRAINT ingredient_in_ingredient_group_ingredient
    FOREIGN KEY (ingredient_id)
    REFERENCES ingredient (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE ingredient_in_ingredient_group ADD CONSTRAINT ingredient_in_ingredient_group_ingredient_group
...
ALTER TABLE ingredient_plan ADD CONSTRAINT ingredient_plan_day_plan
...
ALTER TABLE ingredient_plan ADD CONSTRAINT ingredient_plan_ingredient
    FOREIGN KEY (ingredient_id)
    REFERENCES ingredient (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE ingredient_plan ADD CONSTRAINT ingredient_plan_measure_unit
    FOREIGN KEY (measure_unit_id)
    REFERENCES measure_unit (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE plan_recipe ADD CONSTRAINT plan_recipe_day_plan
    FOREIGN KEY (day_plan_id)
    REFERENCES day_plan (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE plan_recipe ADD CONSTRAINT plan_recipe_recipe
...
ALTER TABLE recipe_picture ADD CONSTRAINT recipe_picture_recipe
    FOREIGN KEY (recipe_id)
    REFERENCES recipe (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE recipe_tags ADD CONSTRAINT recipe_tags_recipe
    FOREIGN KEY (recipe_id)
    REFERENCES recipe (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE recipe_tags ADD CONSTRAINT recipe_tags_tag
    FOREIGN KEY (tag_id)
    REFERENCES tag (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE recipe ADD CONSTRAINT recipe_users
    FOREIGN KEY (users_id)
    REFERENCES users (id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
